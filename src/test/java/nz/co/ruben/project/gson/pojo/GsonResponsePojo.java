...
public class GsonResponsePojo {
    ...
    @SerializedName("data")
    @Expose
    private List<GsonResponsePojo.Datum> data;
    @SerializedName("included")
    @Expose
    private List<GsonResponsePojo.Included> included;
    ...
    public static class Datum {
        ...
        @Expose
        private GsonResponsePojo.Attributes attributes;
        @SerializedName("relationships")
        @Expose
        private GsonResponsePojo.Relationships relationships;
    }
    ...
    public static class Relationships {
        ...
        @Expose
        private GsonResponsePojo.Author author;
    }
    ...
    public static class Author {
        @SerializedName("data")
        @Expose
        private GsonResponsePojo.Datum2 data;
    }
    ...
    public static class Included {
        ...
        @SerializedName("attributes")
        @Expose
        private GsonResponsePojo.Attributes1 attributes;
    }
